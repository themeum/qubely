...
function render_block_qubely_postgrid($att)
{
    ...
    if ($query->have_posts()) {
        ob_start() ?>
        <div class="<?php $class; ?>">
            <div class="qubely-postgrid-wrapper <?php echo $interaction; ?> qubely-postgrid-layout-<?php echo esc_attr($layout); ?>">
            <?php
    ...
    return $html;
} // end of function render_block_qubely_postgrid
