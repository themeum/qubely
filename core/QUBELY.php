...
class QUBELY_MAIN
{
    ...
    public function qubely_editor_assets()
    {
        ...
        if ('widgets.php' !== $pagenow) {
            wp_enqueue_script('qubely-blocks-js', QUBELY_DIR_URL . 'assets/js/qubely.dev.js', ['wp-blocks', 'wp-i18n', 'wp-element', 'wp-editor'], QUBELY_VERSION, true);
        }
    ...
    public function qubely_admin_assets()
    {
        ...
        wp_enqueue_script('qubely-magnific-popup', QUBELY_DIR_URL . 'assets/js/qubely.magnific-popup.js', ['jquery'], QUBELY_VERSION, true);
        wp_enqueue_script('jquery-animatedHeadline', QUBELY_DIR_URL . 'assets/js/jquery.animatedheadline.js', ['jquery'], QUBELY_VERSION, true);
        wp_enqueue_script('qubely-block-map', QUBELY_DIR_URL . 'assets/js/blocks/map.js', ['jquery'], QUBELY_VERSION, true);
        wp_enqueue_script('qubely-block-contactform', QUBELY_DIR_URL . 'assets/js/blocks/contactform.js', ['jquery'], QUBELY_VERSION, true);
        wp_enqueue_script('qubely-block-common', QUBELY_DIR_URL . 'assets/js/common-script.js', ['jquery'], QUBELY_VERSION, true);
    }
    ...
    public function qubely_enqueue_scripts()
    {
         ...
         * register scripts
         */
        wp_register_script('qubley-animated-headline-script', QUBELY_DIR_URL . 'assets/js/jquery.animatedheadline.js', ['jquery'], QUBELY_VERSION, true);
        wp_register_script('qubely-block-map', QUBELY_DIR_URL . 'assets/js/blocks/map.js', ['jquery'], QUBELY_VERSION, true);
        wp_register_script('qubely-magnific-popup-script', QUBELY_DIR_URL . 'assets/js/qubely.magnific-popup.js', ['jquery'], QUBELY_VERSION, true);
        wp_register_script('qubely-block-contactform', QUBELY_DIR_URL . 'assets/js/blocks/contactform.js', ['jquery'], QUBELY_VERSION, true);
        wp_register_script('qubely-block-image-comparison', QUBELY_DIR_URL . 'assets/js/blocks/image-comparison.js', [], QUBELY_VERSION, true);
        wp_register_script('qubely-block-common', QUBELY_DIR_URL . 'assets/js/common-script.js', ['jquery'], QUBELY_VERSION, true);
        wp_register_script('qubely-interaction', QUBELY_DIR_URL . 'assets/js/interaction.js', ['jquery'], QUBELY_VERSION, true);
    ...
    public function add_static_css()
    {
        ...
        // Scripts
        wp_enqueue_script('qubely-magnific-popup-script', QUBELY_DIR_URL . 'assets/js/qubely.magnific-popup.js', ['jquery'], QUBELY_VERSION, true);
        wp_enqueue_script('qubley-animated-headline-script', QUBELY_DIR_URL . 'assets/js/jquery.animatedheadline.js', ['jquery'], QUBELY_VERSION, true);
        wp_enqueue_script('qubely-block-map', QUBELY_DIR_URL . 'assets/js/blocks/map.js', ['jquery'], QUBELY_VERSION, true);
        wp_enqueue_script('qubely-block-image-comparison', QUBELY_DIR_URL . 'assets/js/blocks/image-comparison.js', ['jquery'], QUBELY_VERSION, true);
        wp_enqueue_script('qubely-block-contactform', QUBELY_DIR_URL . 'assets/js/blocks/contactform.js', ['jquery'], QUBELY_VERSION, true);
        wp_enqueue_script('qubely-block-common', QUBELY_DIR_URL . 'assets/js/common-script.js', ['jquery'], QUBELY_VERSION, true);
    }
