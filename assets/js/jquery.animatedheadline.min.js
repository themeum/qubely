...
// (function ($) {
    ...
    animatedHeading.prototype.reset = function(heading){
        if (this.interval > 0) {
    ...
    animatedHeading.prototype.animateHeadline = function ($headlines) {
        ...
        $headlines.each(function () {
            ...
            if (headline.hasClass('loading-bar')) {
                ...
                setTimeout(function () { headline.find('.animated-text-words-wrapper').addClass('is-loading') }, self.barWaiting);
            } else if (headline.hasClass('text-clip')) {
                var spanWrapper = headline.find('.animated-text-words-wrapper'),
                    newWidth = spanWrapper.width() + 10
                spanWrapper.css('width', newWidth);
            } else if (!headline.hasClass('type')) {
                //assign to .animated-text-words-wrapper the width of its longest word
                var words = headline.find('.animated-text-words-wrapper .animated-text.is-visible');
    ...
    animatedHeading.prototype.showWord = function ($word, $duration) {
        ...
        if ($word.parents('.animated-heading-text').hasClass('type')) {
            ...
            $word.parents('.animated-text-words-wrapper').animate({ 'width': $word.width() + 10 }, self.revealDuration, function () {
    ...
    // window.qubelyHeadline = animatedHeading
