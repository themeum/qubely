...
icons.solid = (
	<svg xmlns="http://www.w3.org/2000/svg" width="19" height="2">
		<switch>
			<g>
				<path d="M0 0h19v2H0z" />
			</g>
...
icons.dot = (
	<svg id="Layer_1" xmlns="http://www.w3.org/2000/svg" width="18" height="2">
		<switch>
			<g>
				<g>
					<g transform="translate(-1378 -121)">
						<g transform="translate(1229 110)">
							<g transform="translate(149 11)">
								<circle className="st0" cx="1" cy="1" r="1" />
								<circle className="st0" cx="17" cy="1" r="1" />
								<circle className="st0" cx="5" cy="1" r="1" />
								<circle className="st0" cx="13" cy="1" r="1" />
								<circle className="st0" cx="9" cy="1" r="1" />
							</g>
						</g>
					</g>
				</g>
...
icons.dash = (
	<svg xmlns="http://www.w3.org/2000/svg" width="18" height="2">
		<switch>
			<g>
				<path d="M18 2h-2V0h2v2zm-4 0h-2V0h2v2zm-4 0H8V0h2v2zM6 2H4V0h2v2zM2 2H0V0h2v2z" />
			</g>
		</switch>
	</svg>
);
icons.wave = (
	<svg xmlns="http://www.w3.org/2000/svg" width="21" height="4">
		<switch>
			<g>
				<path d="M8 3.5c-.8 0-1.7-.3-2.5-.9C4 1.5 2.4 1.5.7 2.6c-.2.1-.5.1-.7-.2-.1-.2-.1-.5.2-.7 2-1.3 4-1.3 5.8 0 1.5 1 2.8 1 4.2-.2 1.6-1.4 3.4-1.4 5.3 0 1.5 1.1 3.1 1.2 4.7.1.2-.1.5-.1.7.1.1.2.1.5-.1.7-2 1.3-3.9 1.3-5.8-.1-1.5-1.1-2.9-1.1-4.1 0C9.9 3.1 9 3.5 8 3.5z" />
			</g>
		</switch>
	</svg>
);
...
icons.vertical_top = (
	<svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
		<g transform="translate(1)" fill="none">
			<rect className="qubely-svg-fill" x="4" y="4" width="6" height="12" rx="1" />
			<path className="qubely-svg-stroke" d="M0 1h14" strokeWidth="2" strokeLinecap="square" />
		</g>
	</svg>
);
	...
	<svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
		<g fill="none">
			<g transform="translate(1 1)">
				<rect className="qubely-svg-fill" x="4" width="6" height="14" rx="1" />
				<path d="M0 7h2" className="qubely-svg-stroke" strokeWidth="2" strokeLinecap="square" />
			</g>
			<path d="M13 8h2" className="qubely-svg-stroke" strokeWidth="2" strokeLinecap="square" />
		</g>
	</svg>
);
icons.vertical_bottom = (
	<svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
		<g transform="translate(1)" fill="none">
			<rect className="qubely-svg-fill" x="4" width="6" height="12" rx="1" />
			<path d="M0 15h14" className="qubely-svg-stroke" strokeWidth="2" strokeLinecap="square" />
		</g>
	</svg>
);
...
icons.corner_square = (
	<svg width="12" height="12" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
		<path d="M0 1h10.967v10.763" strokeWidth="2" className="qubely-svg-stroke" fill="none" />
	</svg>
);
icons.corner_rounded = (
	<svg width="12" height="12" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
		<path d="M0 1h6.967c2.209 0 4 1.791 4 4v6.763" strokeWidth="2" className="qubely-svg-stroke" fill="none" />
	</svg>
);
icons.corner_round = (
	<svg width="12" height="12" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
		<path d="M0 1h1.967c4.971 0 9 4.029 9 9v1.763" strokeWidth="2" className="qubely-svg-stroke" fill="none" />
	</svg>
);
...
icons.h1 = (
	<svg width="17" height="13" viewBox="0 0 17 13" xmlns="http://www.w3.org/2000/svg">
		<g className="qubely-svg-fill" fillRule="nonzero">
			<path d="M10.83 13h-2.109v-5.792h-5.924v5.792h-2.101v-12.85h2.101v5.256h5.924v-5.256h2.109z" />
			<path d="M16.809 13h-1.147v-4.609c0-.55.013-.986.039-1.309l-.276.259c-.109.094-.474.394-1.096.898l-.576-.728 2.1-1.65h.957v7.139z" />
		</g>
	</svg>
);
icons.h2 = (
	<svg width="19" height="13" viewBox="0 0 19 13" xmlns="http://www.w3.org/2000/svg">
		<g className="qubely-svg-fill" fillRule="nonzero">
			<path d="M10.83 13h-2.109v-5.792h-5.924v5.792h-2.101v-12.85h2.101v5.256h5.924v-5.256h2.109z" />
			<path d="M18.278 13h-4.839v-.869l1.841-1.851c.544-.557.904-.951 1.082-1.184.177-.233.307-.452.388-.657.081-.205.122-.425.122-.659 0-.322-.097-.576-.291-.762-.194-.186-.461-.278-.803-.278-.273 0-.538.05-.793.151-.256.101-.551.283-.886.547l-.62-.757c.397-.335.783-.573 1.157-.713s.773-.21 1.196-.21c.664 0 1.196.173 1.597.52.4.347.601.813.601 1.399 0 .322-.058.628-.173.918-.116.29-.293.588-.532.896-.239.308-.637.723-1.194 1.248l-1.24 1.201v.049h3.389v1.011z" />
		</g>
	</svg>
);
icons.h3 = (
...
icons.h4 = (
	<svg width="19" height="13" viewBox="0 0 19 13" xmlns="http://www.w3.org/2000/svg">
		<g className="qubely-svg-fill" fillRule="nonzero">
			<path d="M10.83 13h-2.109v-5.792h-5.924v5.792h-2.101v-12.85h2.101v5.256h5.924v-5.256h2.109z" />
			<path d="M18.532 11.442h-.962v1.558h-1.118v-1.558h-3.262v-.884l3.262-4.717h1.118v4.648h.962v.952zm-2.08-.952v-1.792c0-.638.016-1.16.049-1.567h-.039c-.091.215-.234.475-.43.781l-1.772 2.578h2.192z" />
		</g>
	</svg>
);
icons.h5 = (
...
icons.p = (
	<svg width="20px" height="20px" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
...
icons.span = (
	<svg width="20px" height="20px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
		<rect x="0" fill="none" width="20px" height="20px" />
		<g>
...
icons.copy = (
	<svg width="20px" height="15px" viewBox="0 0 1792 1792" className="dashicon" xmlns="http://www.w3.org/2000/svg">
...
icons.spacing = {
	top: (
		<svg width="22" height="22" viewBox="0 0 22 22" xmlns="http://www.w3.org/2000/svg">
			<g fill="none">
				<path fill="#CACCCE" d="M0 3h2v16h-2z" />
				<path fill="#CACCCE" d="M20 3h2v16h-2z" />
				<path fill="#2184F9" d="M3 0h16v2h-16z" />
				<path fill="#CACCCE" d="M3 20h16v2h-16z" />
			</g>
		</svg>
	),
	right: (
		<svg width="22" height="22" viewBox="0 0 22 22" xmlns="http://www.w3.org/2000/svg">
			<g fill="none">
				<path fill="#CACCCE" d="M0 3h2v16h-2z" />
				<path fill="#2184F9" d="M20 3h2v16h-2z" />
				<path fill="#CACCCE" d="M3 0h16v2h-16z" />
				<path fill="#CACCCE" d="M3 20h16v2h-16z" />
			</g>
		</svg>
	),
	bottom: (
		<svg width="22" height="22" viewBox="0 0 22 22" xmlns="http://www.w3.org/2000/svg">
			<g fill="none">
				...
				<path fill="#CACCCE" d="M20 3h2v16h-2z" />
				<path fill="#CACCCE" d="M3 0h16v2h-16z" />
				<path fill="#2184F9" d="M3 20h16v2h-16z" />
			</g>
		</svg>
	),
	left: (
		<svg width="22" height="22" viewBox="0 0 22 22" xmlns="http://www.w3.org/2000/svg">
			<g fill="none">
				<path fill="#2184F9" d="M0 3h2v16h-2z" />
				<path fill="#CACCCE" d="M20 3h2v16h-2z" />
				<path fill="#CACCCE" d="M3 0h16v2h-16z" />
				<path fill="#CACCCE" d="M3 20h16v2h-16z" />
			</g>
...
icons.inlineColorIcon = (
	<svg
		...
		viewBox="0 0 20 20"
	>
		<path d="M13.23 15h1.9L11 4H9L5 15h1.88l1.07-3h4.18zm-1.53-4.54H8.51L10 5.6z"></path>
	</svg>
);
...
icons.upperCaseIcon = (
	<svg viewBox="0 0 20 20" height="25" width="25" xmlns="http://www.w3.org/2000/svg">
		<mask id="a" fill="#fff">
			<path d="m20 20h-20v-20h20z" fill="#fff" fillRule="evenodd" />
		</mask>
		<path
