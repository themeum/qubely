...
const { Styles, ColorAdvanced, Range, Typography, BoxShadow, RadioAdvanced, Tabs, Tab, Color, Toggle, Padding, Border, BorderRadius, withCSSGenerator, InspectorTabs, InspectorTab } = wp.qubelyComponents
