...
registerBlockType ( 'qubely/socialicons', {
    ...
    attributes: {
        ...
        iconPaddingX: { type: 'object', default: {md: 10, unit: 'px'}, style: [{ condition:[{ key: 'layout', relation: '==', value: 'fill' }], selector: '{{QUBELY}} .qubely-block-social-icons .qubely-social-item a {padding-left: {{iconPaddingX}}; padding-right: {{iconPaddingX}};}' }] },
        iconPaddingY: { type: 'object', default: {md: 10, unit: 'px'}, style: [{ condition:[{ key: 'layout', relation: '==', value: 'fill' }], selector: '{{QUBELY}} .qubely-block-social-icons .qubely-social-item a {padding-top: {{iconPaddingY}}; padding-bottom: {{iconPaddingY}};}' }] },
