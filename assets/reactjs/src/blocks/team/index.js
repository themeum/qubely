...
registerBlockType ( 'qubely/team', {
    ...
    attributes: {
        ...
        alignment: { type: 'object', default: {md: 'center'},
            style: [
                {
        ...
        imageWidth: { type: 'object', default: {},
            style: [
                {
                    condition:[
        ...
        imageSpacing: { type: 'object', default: {md: 20, unit: 'px'},
            style: [
                {
                    condition:[
        ...
        designationTypo: { type: 'object', default:{openTypography: 1, size: {md: 14, unit: 'px'}},
            style: [
                {
                    condition:[
        ...
        designationColor: { type: 'string', default: '',
            style: [
                {
                    condition:[
                        { key: 'enableDesignation', relation: '==', value: 1 }
        ...
        designationSpacing: { type: 'object', default: {md: 20, unit: 'px'},
            style: [
                {
                    condition:[
                        { key: 'enableDesignation', relation: '==', value: 1 }
        ...
        descriptionTypo: { type: 'object', default:{openTypography: 1, size: {md: 14, unit: 'px'}},
            style: [
                {
                    condition:[
        ...
        descriptionSpacing: { type: 'object', default: {md: 10, unit: 'px'},
            style: [
                {
                    condition:[
                        { key: 'enableDescription', relation: '==', value: 1 }
        ...
        iconSizeCustom: { type: 'object', default: {md: 18, unit: 'px'},
            style: [
                {
                    condition:[
                        { key: 'iconSize', relation: '==', value: 'custom' },
        ...
        iconGutter: { type: 'object', default: {md: 10, unit: 'px'},
            style: [
                {
        ...
        iconBackgroundHover: {type: 'string', default: '',
            style: [
                {
                    condition:
                    [
        ...
        iconBorder: {type: 'object', default: {},
            style: [
                {
                    condition:
                    [
        ...
        iconBorderColorHover: {type: 'string', default: '',
            style: [
                {
                    condition:
                    [
        ...
        infoSpacing: { type: 'object', default: {md: 10, unit: 'px'},
            style: [
                {
        ...
        infoIconSize: { type: 'string', default: '14px',
            style: [
                {
                    condition:[
        ...
        infoIconSizeCustom: { type: 'object', default: {md: 10, unit: 'px'},
            style: [
                {
                    condition:[
                        { key: 'useInfoIcon', relation: '==', value: true },
        ...
        infoIconSpacing: { type: 'object', default: {md: 10, unit: 'px'},
            style: [
                {
        ...
        //Overlay
        overlayHeight: {type: 'string', default: 'fit',
            style: [
                {
                    condition:[
                        { key: 'layout', relation: '==', value: 2 },
        ...
        overlayAlignment: {type: 'string', default: 'center',
            style: [
                {
                    condition:[
                        { key: 'layout', relation: '==', value: 2 },
        ...
        overlayBg: { type: 'object', default: { type: 'color', openColor: 1, color: 'rgba(255, 255, 255, .9)' },
            style: [
                {
                    condition:[
                        { key: 'layout', relation: '==', value: 2 },
        ...
        overlayPaddingX: {type: 'object', default: {md: 20, unit: 'px'},
            style: [
                {
                    condition:[
                        { key: 'layout', relation: '==', value: 2 }
        ...
        overlayPaddingY: {type: 'object', default: {md: 20, unit: 'px'},
            style: [
                {
                    condition:[
                        { key: 'layout', relation: '==', value: 2 }
        ...
        // Content
        contentPosition: {type: 'string', default: 'right',
            style: [
                {
                    condition:[
        ...
        contentAlignment: {type: 'string', default: 'flex-start',
            style: [
                {
                    condition:[
                        { key: 'layout', relation: '==', value: 3 },
                    ],
                    selector: '{{QUBELY}} .qubely-team-content {-webkit-box-align: {{contentAlignment}}; -ms-flex-align: {{contentAlignment}}; align-items: {{contentAlignment}};}'
                }
            ]
        },
        contentPaddingX: {type: 'object', default: {md: 20, unit: 'px'},
            style: [
                {
                    condition:[
                        { key: 'layout', relation: '==', value: 3 }
                    ],
                    selector: '{{QUBELY}} .qubely-team-content {padding-left: {{contentPaddingX}}; padding-right: {{contentPaddingX}};}' 
                }
            ]
        },
        contentPaddingY: {type: 'object', default: {md: 20, unit: 'px'},
            style: [
                {
                    condition:[
                        { key: 'layout', relation: '==', value: 3 }
                    ],
                    selector: '{{QUBELY}} .qubely-team-content {padding-top: {{contentPaddingY}}; padding-bottom: {{contentPaddingY}};}' 
                }
            ]
        },
        contentBg: { type: 'object', default: { type: 'color', openColor: 1, color: '#fff' },
            style: [
                {
                    condition:[
                        { key: 'layout', relation: '==', value: 3 },
        ...
        contentBorder: { type: 'object', default: {openBorder: 1, position: 'all', type: 'solid', width: 1, color: '#e5e5e5'},
            style: [
                {
                    condition:[
                        { key: 'layout', relation: '==', value: 3 },
        ...
        bodyBorder: {type: 'object', default: {},
            style: [
                {
                    selector: '{{QUBELY}} .qubely-block-team'
                }
        ...
        bodyBoxShadow: {type: 'object', default: {},
            style: [
                {
                    selector: '{{QUBELY}} .qubely-block-team'
                }
