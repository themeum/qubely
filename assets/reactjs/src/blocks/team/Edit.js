					...
					<InspectorTabs tabs={["style", "advance"]}>
						<InspectorTab key={"style"}>
							...
							<PanelBody
								...
								onToggle={() => this.handlePanelOpenings(openPanelSetting !== "Image" ? "Image" : "")}
							>
								<ButtonGroup
									label={__("Image Type")}
									options={[
							...
							>
								...
								<Range
									label={__("Spacing")}
									value={nameSpacing}
									onChange={(val) => setAttributes({ nameSpacing: val })}
									min={0}
									max={60}
									unit={["px", "em", "%"]}
									responsive
							...
							>
								<Toggle
									...
									onChange={(val) => setAttributes({ enableDesignation: val })}
								/>
								{enableDesignation == 1 && (
									<Fragment>
										<Separator />
										...
										<Range
											...
											onChange={(val) => setAttributes({ designationSpacing: val })}
											min={0}
											max={60}
											unit={["px", "em", "%"]}
											responsive
								...
								{enableDescription == 1 && (
									<Fragment>
										<Typography
											...
											onChange={(value) => setAttributes({ descriptionTypo: value })}
											device={device}
											onDeviceChange={(value) => this.setState({ device: value })}
										/>
										<Color
										...
										<Range
											...
											onChange={(val) => setAttributes({ descriptionSpacing: val })}
											min={0}
											max={60}
											unit={["px", "em", "%"]}
											responsive
								...
								{(phone || email || website) && (
									<Fragment>
										<Typography
											label="Typography"
											value={infoTypo}
											onChange={(value) => setAttributes({ infoTypo: value })}
											device={device}
											onDeviceChange={(value) => this.setState({ device: value })}
										/>
										<Color
											label={__("Color")}
											value={infoColor}
											onChange={(value) => setAttributes({ infoColor: value })}
										/>
										<Range
											label={__("Spacing")}
											value={infoSpacing}
											onChange={(val) => setAttributes({ infoSpacing: val })}
											min={0}
											max={60}
											unit={["px", "em", "%"]}
											responsive
										...
										<Toggle
											label={__("Use Icon")}
											value={useInfoIcon}
											onChange={(val) => setAttributes({ useInfoIcon: val })}
										/>
										{useInfoIcon == 1 && (
											<Fragment>
												<RadioAdvanced
													label={__("Icon Size")}
													value={infoIconSize}
													onChange={(value) => setAttributes({ infoIconSize: value })}
													options={[
												...
												{infoIconSize == "custom" && (
													<Range
														...
														onChange={(val) => setAttributes({ infoIconSizeCustom: val })}
														min={12}
														max={300}
														unit={["px", "em", "%"]}
														responsive
												...
												<Color
													label={__("Color")}
													value={infoIconColor}
													onChange={(value) => setAttributes({ infoIconColor: value })}
												/>
												<Range
													label={__("Icon Spacing")}
													value={infoIconSpacing}
													onChange={(val) => setAttributes({ infoIconSpacing: val })}
													min={0}
													max={60}
													unit={["px", "em", "%"]}
													responsive
							...
							<PanelBody
								...
								onToggle={() => this.handlePanelOpenings(openPanelSetting !== "Social" ? "Social" : "")}
							>
								<Toggle
								...
								{showSociallinks && (
									<Fragment>
										...
										<TextControl
											label={__("Youtube")}
											value={youtube}
											onChange={(val) => setAttributes({ youtube: val })}
										/>
										<TextControl
											label={__("Github")}
											value={github}
											onChange={(val) => setAttributes({ github: val })}
										/>
										<TextControl
											label={__("Flickr")}
											value={flickr}
											onChange={(val) => setAttributes({ flickr: val })}
										/>
										<TextControl
											label={__("Pinterest")}
											value={pinterest}
											onChange={(val) => setAttributes({ pinterest: val })}
										/>
										<TextControl
											label={__("Dribbble")}
											value={dribbble}
											onChange={(val) => setAttributes({ dribbble: val })}
										/>
										<TextControl
											label={__("Behance")}
											value={behance}
											onChange={(val) => setAttributes({ behance: val })}
										/>
										<Separator />
										<Styles
											label={__("Icon Style")}
										...
										<Range
											label={__("Gutter")}
											value={iconGutter}
											onChange={(val) => setAttributes({ iconGutter: val })}
											min={0}
											max={40}
											unit={["px", "em"]}
											responsive
										...
										<Toggle
											...
											onChange={(val) => setAttributes({ iconUseDefaultStyle: val })}
										/>
							...
							{layout == 2 && (
								<Fragment>
									<PanelBody title={__("Overlay")} initialOpen={false}>
										...
										/>
										<Range
											label={<span className="dashicons dashicons-sort" title="Y Padding" />}
							...
							<PanelBody title={__("Background")} initialOpen={false}>
								...
								<BorderRadius
									...
									onChange={(val) => setAttributes({ bodyBorderRadius: val })}
									min={0}
									max={100}
									unit={["px", "em", "%"]}
									responsive
								...
								<BoxShadow
									label={__("Box-Shadow")}
									value={bodyBoxShadow}
									onChange={(value) => setAttributes({ bodyBoxShadow: value })}
								/>
							</PanelBody>
						</InspectorTab>
							...
							<div className="qubely-team-content-inner">
								...
								{(phone || email || website) && (
									<div
										...
										onClick={() => this.handlePanelOpenings("Information")}
									>
										{phone && (
											<div className={`qubely-team-information-phone`}>
												{useInfoIcon && (
													<i
														className="qubely-info-icon fas fa-phone"
														aria-label={__("Phone")}
													/>
												)}
												<span>{phone}</span>
