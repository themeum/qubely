...
registerBlockType("qubely/icon", {
	...
	attributes: {
		...
		alignment: {
			type: "object",
			default: { md: "center" },
			style: [{ selector: "{{QUBELY}} .qubely-block-icon-wrapper {text-align: {{alignment}};}" }],
		},
		iconStyle: { type: "string", default: "nofill" },
		iconColor: {
			type: "string",
			default: "var(--qubely-color-1)",
			style: [{ selector: "{{QUBELY}} .qubely-block-icon i {color: {{iconColor}};}" }],
		},
		iconHoverColor: {
			type: "string",
			default: "var(--qubely-color-2)",
			style: [{ selector: "{{QUBELY}} .qubely-block-icon:hover i {color: {{iconHoverColor}};}" }],
		},
		bgColor: {
			type: "object",
			default: { openColor: 1, type: "color", color: "#D6EBFF" },
			style: [
				{
		...
		bgHoverColor: {
			type: "object",
			default: { openColor: 1, type: "color", color: "#B4D9FF", gradient: {} },
			style: [
				{
		...
		borderHoverColor: {
			...
			style: [
				{
					condition: [{ key: "iconStyle", relation: "!=", value: "nofill" }],
					selector: "{{QUBELY}} .qubely-block-icon:hover {border-color: {{borderHoverColor}};}",
				},
			],
		},
		iconSize: {
			...
			style: [
				{
					...
					selector: "{{QUBELY}} .qubely-block-icon {font-size: {{iconSize}};}",
				},
			],
		},
		iconSizeCustom: {
			...
			style: [
				{
					condition: [{ key: "iconSize", relation: "==", value: "custom" }],
					selector: "{{QUBELY}} .qubely-block-icon {font-size: {{iconSizeCustom}};}",
				},
			],
		},
		iconBackgroundSize: {
			...
			style: [
				{
					condition: [{ key: "iconStyle", relation: "!=", value: "nofill" }],
					selector: "{{QUBELY}} .qubely-block-icon { padding: {{iconBackgroundSize}};}",
				},
			],
		},
		iconBorderRadius: {
