...
import { Styles, Wrapper, Range, Toggle, Typography, Color, Tabs, Tab, Border, RadioAdvanced, InnerPanel, QubelyButtonEdit, BorderRadius, Separator } from '../../components/FieldRender'
                ...
                <InspectorControls key="inspector">
                    ...
                    <PanelBody title={ __( 'Input' ) } initialOpen={false}>
                        ...
                        <BorderRadius
                            ...
                            responsive 
                        />
                        <Typography label={__('Typography')} value={ inputTypography } onChange={ val => setAttributes( { inputTypography: val } ) } />
                    </PanelBody>
