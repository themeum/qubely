...
const attributes = {
	...
	gutter: {
		...
		style: [
			{
				selector:
					"{{QUBELY}} .qubely-form {margin: 0 calc(-{{gutter}}/2);} {{QUBELY}} .qubely-form .qubely-form-group {padding: 0 calc({{gutter}}/2);}",
			},
		],
	},
		...
		style: [
			{
				condition: [{ key: "layout", relation: "==", value: "material" }],
				selector:
					"{{QUBELY}} .qubely-form-control:focus ~ .qubely-form-label, {{QUBELY}} .qubely-form-control:valid ~ .qubely-form-label {color: {{labelColorFocus}};}",
			},
		],
	},
	...
	inputTypography: {
		...
		style: [
			{
				selector:
					"{{QUBELY}} .qubely-form .qubely-form-control, {{QUBELY}} .qubely-form .qubely-form-control::placeholder",
			},
		],
	},
	...
	inputColor: {
		type: "string",
		default: "#495057",
		style: [{ selector: "{{QUBELY}} .qubely-form .qubely-form-control {color: {{inputColor}};}" }],
	},
	...
	inputColorFocus: {
		type: "string",
		default: "#495057",
		style: [{ selector: "{{QUBELY}} .qubely-form .qubely-form-control:focus {color: {{inputColorFocus}};}" }],
	},
	...
	placeholderColor: {
		...
		default: "#818181",
		style: [
			{ selector: "{{QUBELY}} .qubely-form .qubely-form-control::placeholder {color: {{placeholderColor}};}" },
		],
	},
	placeholderColorHover: {
		...
		style: [
			{
				selector:
					"{{QUBELY}} .qubely-form .qubely-form-control::placeholder:Hover {color: {{placeholderColorHover}};}",
			},
		],
	},
	placeholderColorFocus: {
		...
		style: [
			{
				selector:
					"{{QUBELY}} .qubely-form .qubely-form-control::placeholder:focus {color: {{placeholderColorFocus}};}",
			},
		],
	},
		...
		style: [
			{
				condition: [{ key: "layout", relation: "==", value: "classic" }],
				selector:
					"{{QUBELY}} .qubely-form .qubely-form-control:hover {border-color: {{inputBorderColorHover}};}",
			},
			{
				condition: [{ key: "layout", relation: "==", value: "material" }],
				selector:
					"{{QUBELY}} .qubely-form .qubely-form-control:hover {border-bottom-color: {{inputBorderColorHover}};}",
			},
		],
	},
		...
		style: [
			{
				condition: [{ key: "layout", relation: "==", value: "classic" }],
				selector:
					"{{QUBELY}} .qubely-form .qubely-form-control:focus {border-color: {{inputBorderColorFocus}};}",
			},
			{
				condition: [{ key: "layout", relation: "==", value: "material" }],
				selector:
					"{{QUBELY}} .qubely-form .qubely-form-control:focus {border-bottom-color: {{inputBorderColorFocus}};}",
			},
		],
	},
		...
		style: [
			{
				...
				selector:
					"{{QUBELY}} .qubely-form .qubely-form-control {padding-top: {{inputPaddingY}}; padding-bottom: {{inputPaddingY}};}",
			},
			{
				condition: [
		...
		style: [
			{
				...
				selector:
					"{{QUBELY}} .qubely-form .qubely-form-control {padding-left: {{inputPaddingX}}; padding-right: {{inputPaddingX}};}",
			},
		],
	},
	textareaHeight: {
		...
		style: [
			{
				selector:
					"{{QUBELY}} .qubely-form .qubely-form-group textarea.qubely-form-control {height: {{textareaHeight}};}",
			},
		],
	},
