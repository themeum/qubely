...
const { Color, IconList, Select, Styles, Typography, Range, RadioAdvanced, Toggle, BoxShadow, Alignment, Tabs, Tab, Separator, Border, Padding, BorderRadius, CssGenerator: { CssGenerator } } = wp.qubelyComponents
