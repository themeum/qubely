...
registerBlockType('qubely/tabs', {
    ...
    attributes: {
        ...
        // Size
        navSize: { type: 'string', default: '6px 15px',
            style: [
                {
                    condition:[
        ...
        navPaddingY: { type: 'object', default: { md: 10, unit: 'px' },
            style: [
                {
                    condition:[
                        { key: 'navSize', relation: '==', value: 'custom' }
        ...
        navPaddingX: { type: 'object', default: { md: 10, unit: 'px' },
            style: [
                {
                    condition:[
                        { key: 'navSize', relation: '==', value: 'custom' }
        ...
        navBg: { type: 'string', default: '#F5F5F5',
            style: [
                {
                    condition:[
        ...
        navBgActive: { type: 'string', default: '#e5e5e5',
            style: [
                {
                    condition:[
                        { key: 'tabStyle', relation: '!=', value: 'underline' }
        ...
        navUnderlineBorderColor: { type: 'string', default: '',
            style: [
                {
                    condition:[
                        { key: 'tabStyle', relation: '==', value: 'underline' }
        ...
        navUnderlineBorderColorActive: { type: 'string', default: '#2184F9',
            style: [
                {
                    condition:[
                        { key: 'tabStyle', relation: '==', value: 'underline' }
        ...
        bodyShadow: { type: 'object', default: { horizontal: 2, vertical: 2, blur: 3, spread: '0' },
            style: [
                {
                    condition:[
                        { key: 'tabStyle', relation: '==', value: 'tabs' }
        ...
        bodySeparatorColor: { type: 'string', default: '#e5e5e5',
            style: [
                {
                    condition:[
                        { key: 'tabStyle', relation: '==', value: 'underline' }
        ...
        bodyTopSpacing: { type: 'object', default: { md: 20, unit: 'px' },
            style: [
                {
                    condition:[
                        { key: 'tabStyle', relation: '!=', value: 'tabs' }
