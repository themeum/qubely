...
registerBlockType("qubely/counter", {
	...
	attributes: {
		...
		alignment: {
			type: "object",
			default: { md: "center" },
			style: [{ selector: "{{QUBELY}} .qubely-block-counter {text-align: {{alignment}};}" }],
		},
		...
		prepostTypo: {
			type: "object",
			default: {},
			style: [{ selector: "{{QUBELY}} .qubely-block-counter-prefix, {{QUBELY}} .qubely-block-counter-postfix" }],
		},
		prepostColor: {
			type: "string",
			default: "",
			style: [
				{
					selector:
						"{{QUBELY}} .qubely-block-counter-prefix {color: {{prepostColor}};} {{QUBELY}} .qubely-block-counter-postfix {color: {{prepostColor}};}",
				},
			],
		},
		prepostSpacing: {
			...
			style: [
				{
					selector:
						"{{QUBELY}} .qubely-block-counter-prefix {margin-right: {{prepostSpacing}};} {{QUBELY}} .qubely-block-counter-postfix {margin-left: {{prepostSpacing}};}",
				},
			],
		},
		...
		counterColor: {
			type: "string",
			default: "",
			style: [{ selector: "{{QUBELY}} .qubely-block-counter-content {color: {{counterColor}};}" }],
		},
