...
const attributes = {
	...
	imageBorderRadius: {
		...
		style: [
			{
				selector:
					"{{QUBELY}} .qubely-block-image .qubely-image-container, {{QUBELY}} .qubely-block-image .qubely-image-container img",
			},
		],
	},
		...
		style: [
			{
				...
				selector:
					"{{QUBELY}} .qubely-image-container .qubely-image-content .qubely-image-content-inner .qubely-image-title",
			},
		],
	},
	titleColor: {
		...
		style: [
			{
				selector:
					"{{QUBELY}} .qubely-image-container .qubely-image-content .qubely-image-content-inner .qubely-image-title {color: {{titleColor}};}",
			},
		],
	},
		...
		style: [
			{
				...
				selector:
					"{{QUBELY}} .qubely-image-container .qubely-image-content .qubely-image-content-inner .qubely-image-sub-title",
			},
		],
	},
	subTitleColor: {
		...
		style: [
			{
				...
				selector:
					"{{QUBELY}} .qubely-image-container .qubely-image-content .qubely-image-content-inner .qubely-image-sub-title {color: {{subTitleColor}};}",
			},
		],
	},
	subTitleSpacing: {
		...
		style: [
			{
				...
				selector:
					"{{QUBELY}} .qubely-image-container:before {mix-blend-mode: {{overlayBlend}};} {{QUBELY}} .qubely-image-container:after {mix-blend-mode: {{overlayBlend}};}",
			},
		],
	},
	...
	contentVerticalAlign: {
		...
		style: [
			...
			},
			{
				...
				selector:
					"{{QUBELY}} .qubely-image-content {-webkit-box-align: center; -ms-flex-align: center; -ms-grid-row-align: center; align-items: center;}",
			},
			{
				condition: [
					{ key: "layout", relation: "==", value: "blurb" },
				...
				selector:
					"{{QUBELY}} .qubely-image-content {-webkit-box-align: end; -ms-flex-align: end; -ms-grid-row-align: flex-end; align-items: flex-end;}",
			},
		],
	},
	...
	deprecated: [
		{
			...
			save(props) {
				...
				const renderImage = () => {
					const {
						attributes: { image, image2x, imgAlt },
					} = props;
					return (
						<Fragment>
							{image.url != undefined ? (
