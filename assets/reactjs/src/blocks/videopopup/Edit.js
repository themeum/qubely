			...
			<Fragment>
						...
						<InspectorTab key={"style"}>
							...
							<PanelBody title={__("Icon")} initialOpen={false}>
								...
								<Tabs>
									...
									<Tab tabTitle={__("Hover")}>
										...
										<Border
											label={__("Border")}
											value={hoverBorder}
											onChange={(val) => setAttributes({ hoverBorder: val })}
											min={0}
											max={20}
											responsive
											unit
								...
								{iconBgColor && (
									<Toggle
										...
										value={isRipple}
										onChange={(val) => setAttributes({ isRipple: val })}
									/>
								)}
							</PanelBody>
							...
							<PanelBody title={__("Prefix & Postfix")} initialOpen={false}>
								...
								<TextControl
									label={__("Postfix")}
									value={postfix}
									onChange={(val) => setAttributes({ postfix: val })}
								/>
								{(prefix || postfix) && (
									<Fragment>
										<Range
											label={__("Spacing")}
											value={textGap}
											onChange={(val) => setAttributes({ textGap: val })}
											min={0}
											max={150}
											unit={["px", "em", "%"]}
											responsive
										...
										<Tabs>
											...
											<Tab tabTitle={__("Hover")}>
												<Color
													...
													onChange={(val) => setAttributes({ prePostHoverColor: val })}
												/>
											</Tab>
										</Tabs>
									</Fragment>
										...
										{background.openBg == 1 && (
											<Fragment>
												...
												<Toggle
													...
													onChange={(val) => setAttributes({ enableBackgroundOverlay: val })}
												/>
				...
				<BlockControls>
					<Toolbar
						...
						label={__("Video Popup Options", "qubely")}
					>
						<InlineToolbar
