...
registerBlockType('qubely/carousel', {
	...
	attributes: {
		...
		messageTypo: { type: 'object', default: { openTypography: 1, size: { md: 16, unit: 'px' } }, style: [{ selector: '{{QUBELY}} .qubely-testimonial-content' }] },
		...
		bgColor: { 
			type: 'object', default: {}, 
			style: [
				{ selector: '{{QUBELY}} .qubely-block-testimonial'},
			],
		},
