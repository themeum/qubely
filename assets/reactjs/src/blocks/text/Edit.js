								...
								{dropCap == 1 && (
									<Fragment>
										<Range
											label={__("Size")}
											value={dropCapSize}
											onChange={(value) => setAttributes({ dropCapSize: value })}
											min={0}
											max={200}
											unit={["px", "em", "%"]}
											responsive
										...
										<Color
											label={__("Color")}
											value={dropCapColor}
											onChange={(val) => setAttributes({ dropCapColor: val })}
										/>
										<Range
											label={__("Spacing")}
											value={dropCapSpacing}
											onChange={(value) => setAttributes({ dropCapSpacing: value })}
											min={0}
											max={100}
											unit={["px", "em", "%"]}
											responsive
