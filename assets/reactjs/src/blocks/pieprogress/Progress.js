				...
				{progressShadow.openShadow === true &&
					(progressShadow.inset !== "inset" ? (
						<filter id={`progress-shadow-${uniqueId}`} width="500%" height="500%" x="-250%" y="-250%">
							<feDropShadow
								dx={progressShadow.vertical * -1}
								dy={progressShadow.horizontal}
								stdDeviation={progressShadow.blur}
								flood-color={progressShadow.color}
								flood-opacity="1"
							/>
						</filter>
					) : (
				...
				{circleShadow.openShadow === true &&
					(circleShadow.inset !== "inset" ? (
						<filter id={`circle-shadow-${uniqueId}`} width="500%" height="500%" x="-250%" y="-250%">
							<feDropShadow
								dx={circleShadow.vertical * -1}
								dy={circleShadow.horizontal}
								stdDeviation={circleShadow.blur}
								flood-color={circleShadow.color}
								flood-opacity="1"
							/>
						</filter>
					) : (
