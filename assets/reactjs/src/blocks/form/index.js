...
registerBlockType ( 'qubely/form', {
    ...
    attributes: {
        ...
        inputBorder: { type: 'object', default: {openBorder: 1, type: 'solid', widthType: 'all', width: { all: 1 }, color: '#ced4da'},
            style: [
                {
                    condition:[
                        { key: 'layout', relation: '==', value: 'classic' },
        ...
        inputBorderMaterial: { type: 'object', default: {openBorder: 1, type: 'solid', widthType: 'custom', width: { bottom: 2 }, color: '#ced4da'},
            style: [
                {
                    condition:[
                        { key: 'layout', relation: '==', value: 'material' },
