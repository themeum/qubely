			...
			style: [
				{
					...
					selector:
						"{{QUBELY}} .qubely-block-heading .qubely-separator-type-css {border-top-style: {{separatorStyle}};}",
				},
			],
		},
			...
			style: [
				{
					condition: [{ key: "separatorStyle", relation: "!=", value: "" }],
					selector:
						"{{QUBELY}} .qubely-block-heading .qubely-separator-type-svg svg .qubely-separator-stroke {stroke: {{separatorColor}};} {{QUBELY}} .qubely-block-heading svg .qubely-separator-fill {fill: {{separatorColor}};} {{QUBELY}} .qubely-block-heading  .qubely-separator-type-css {border-top-color: {{separatorColor}};}",
				},
			],
		},
		separatorStroke: {
			...
			style: [
				{
					condition: [{ key: "separatorStyle", relation: "!=", value: "" }],
					selector:
						"{{QUBELY}} .qubely-block-heading .qubely-separator-type-svg svg .qubely-separator-stroke {stroke-width: {{separatorStroke}}px;} {{QUBELY}} .qubely-block-heading .qubely-separator-type-css {border-top-width: {{separatorStroke}}px;}",
				},
			],
		},
		separatorWidth: {
			...
			style: [
				{
					condition: [{ key: "separatorStyle", relation: "!=", value: "" }],
					selector:
						"{{QUBELY}} .qubely-block-heading .qubely-separator-type-css {width: {{separatorWidth}}px;} {{QUBELY}} .qubely-block-heading .qubely-separator-type-svg svg {width: {{separatorWidth}}px;}",
				},
			],
		},
		separatorSpacing: {
			...
			style: [
				{
					...
					selector:
						"{{QUBELY}} .qubely-block-heading .qubely-sub-heading-selector {color: {{subHeadingColor}};}",
				},
			],
		},
		subHeadingPosition: {
			...
			style: [
				{
					...
					selector:
						"{{QUBELY}} .qubely-block-heading .qubely-sub-heading-selector {margin-top: {{subHeadingSpacing}};}",
				},
				{
					condition: [
						{ key: "subHeading", relation: "==", value: 1 },
					...
					selector:
						"{{QUBELY}} .qubely-block-heading .qubely-sub-heading-selector {margin-bottom: {{subHeadingSpacing}};}",
				},
			],
		},
