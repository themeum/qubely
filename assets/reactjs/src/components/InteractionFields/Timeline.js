...
class Timeline extends Component {
    ...
    contextMenu(index){
        ...
        return(
            <div style={style} className="qubely-action-context-menu" ref={this.setContextMenuRoot.bind(this)}>
                <div className="qubely-action-content-menu-item" onClick={this._onDeleteItem.bind(this,index)}> <i className="fa fa-trash"/> Delete </div>
                <div className="qubely-action-content-menu-item" onClick={this._onDuplicateItem.bind(this,index)}> <i className="fa fa-clone"/> Duplicate </div>
            </div>
        )
    }
    ...
    parentItemHtml(actions, ci){
        ...
        return (
            <div className={`qubely-parent-item-container ${mouseOverClass}`} 
            key={ci}
    ...
    actionBlankSpaceHtml(keyFrame, lastKeyframe, id, index){
        ...
        if(keyFrame === 0 )
            style.padding = 0
        return(
            <div key={this.revisedRandId()} className="qubely-action-item-blank-space"
        ...
        return(
            <div className="qubely-animation-action-option-box" ref={ref => this.actionListWrapper = ref }>
                <div className="qubely-animation-action-option-lists">
                    { interactionActions.map((action, index) => <div key={index} onClick={this.createAction.bind(this, action, rowIndex)} className="qubely-animation-action-option-item">{action.name}</div>) }
                </div>
            </div>
        )
    }
            ...
            <div className="qubely-animation-timeline-container">
                <div className="qubely-animation-view">
                    <div className="qubely-animation-trigger-header">
                        ...
                        <span className="qubely-add-animation-action-btn" onClick={this.showActionList.bind(this)}>﹢</span>
                    ...
                    <div className="qubely-animation-flexible-area">
                        <div
                            ...
                            >
                            <div className="qubely-animation-timline-bar" ref={ref=> this.timeLineBarWrapper = ref } />
                            ...
                            <div style={pointerStyle} className="qubely-timeline-pointer-hr-line"
                                 onClick={this.showAnimationAction.bind(this)}>
                                <div className="qubely-action-item-pointer">
                                    <span> {percentage}% </span>
                                </div>
                                <div className="qubely-action-item-pointer-icon"><span>+</span></div>
