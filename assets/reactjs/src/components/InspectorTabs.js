	...
	return (
		<Fragment>
			<div className={'qubely-inspector-tabs-container'}>
				...
				<div
					ref={tabContainer}
					className={classnames('qubely-inspector-tabs', 'qubely-inspector-tabs-count-' + tabs.length, currentTab)}
				>
					{tabs.indexOf(STYLE) > -1 && (
						<Tooltip text={__('Style')}>
							<button
								className={classnames({ 'qubely-active': currentTab === STYLE })}
					...
					{tabs.indexOf(ADVANCE) > -1 && (
						<Tooltip text={__('Advanced')}>
							<button
								className={classnames({ 'qubely-active': currentTab === ADVANCE })}
					...
					{tabs.indexOf(LAYOUT) > -1 && (
						<Tooltip text={__('Layout')}>
							<button
								className={classnames({ 'qubely-active': currentTab === LAYOUT })}
