...

                    {
                        tabs.indexOf(STYLE) > -1 && (
                            <Tooltip text={__('Style')}>
                                <button className={currentTab === STYLE ? 'qubely-active' : ''} onClick={() => _onTabChange(STYLE)}>
...

                    {
                        tabs.indexOf(ADVANCE) > -1 && (
                            <Tooltip text={__('Advance')}>
                                <button className={currentTab === ADVANCE ? 'qubely-active' : ''} onClick={() => _onTabChange(ADVANCE)}>
