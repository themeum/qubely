		...
		return (
			<div className="qubely-context-menu">
				<div className="qubely-context-menu-group">
					<div
						className="qubely-context-menu-item qubely-context-menu-item-copy"
						onClick={() => this.copyStyles()}
					>
						<div className={`qubely-context-menu-item-icon`}>
							{" "}
					...
					<div
						className={`qubely-context-menu-item qubely-context-menu-item-paste disable-${
							previouslyCopiedStyle && previouslyCopiedStyle.blockName == name
								? sourceOfCopiedStyle
								: true
						}`}
				...
				<div className="qubely-context-menu-group">
					<div
						className="qubely-context-menu-item qubely-context-menu-item-delete"
