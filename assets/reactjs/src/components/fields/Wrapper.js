...
class Wrapper extends Component {
  ...
  */
    ...
    render() {
        ...
        return (
            <Fragment>
                <div ref="qubelyPopUpWraper" id="qubely-field-wrapper" style={{ ...cssStyle }} className={`qubely-field qubely-field-wrapper ${inline ? 'qubely-field-wrapper-inline' : ''} ${customClass} ${positionClass}`}>
