            ...
            <div className={className}>
                <div className="qubely-field-tab-header">
                    ...
                    <div className="qubely-field-tab-menus">
                        {tabs.map((tab, i) =>
                            <Tooltip key={i} text={__(tab.props.tabTitle)} >
                                <TEMPTAG {...panelGroup && { className: 'tab-menu-wrapper' }}>
                                    {
                                        panelGroup && <svg width="21" height="18" viewBox="0 0 21 18" xmlns="http://www.w3.org/2000/svg"><g transform="translate(-29 -4) translate(29 4)" fill="none"><path d="M1 .708v15.851" className="qubely-svg-stroke" strokeLinecap="square" /><rect className="qubely-svg-fill" x="5" y="5" width="16" height="7" rx="1" /></g></svg>
                                    }
                                    <button
