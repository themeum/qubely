                                    ...
                                    <button className={((value.bgType == data && value.openBg) ? 'active' : '') + ' qubely-button'} onClick={() => this.setSettings(data, 'bgType')}>
                                        ...
                                        {data == 'video' &&
                                            <Tooltip text={ __( 'Video' )  }>
                                                <svg width="18" height="14" viewBox="0 0 18 14" xmlns="http://www.w3.org/2000/svg"><path d="M18 1.679v10.929c0 .281-.131.479-.392.593-.087.033-.171.05-.251.05-.181 0-.331-.064-.452-.191l-4.048-4.048v1.667c0 .797-.283 1.478-.849 2.044-.566.566-1.247.849-2.044.849h-7.071c-.797 0-1.478-.283-2.044-.849-.566-.566-.849-1.247-.849-2.044v-7.071c0-.797.283-1.478.849-2.044.566-.566 1.247-.849 2.044-.849h7.071c.797 0 1.478.283 2.044.849.566.566.849 1.247.849 2.044v1.657l4.048-4.038c.121-.127.271-.191.452-.191.08 0 .164.017.251.05.261.114.392.311.392.593z" className="qubely-svg-fill" fill-rule="nonzero"/></svg>
                                            </Tooltip>
                                        }
                                    </button>
                                )
