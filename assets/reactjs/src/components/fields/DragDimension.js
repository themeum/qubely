        ...
        return (
            ...
            <div className={'qubely-drag-dimension qubely-field'}>
                <div className="qubely-field qubely-field-border qubely-d-flex qubely-align-center">
                    ...
                    {
                        this.props.responsive && <Device className="qubely-ml-10" onChange={(val) => this.setState({ responseDevice: val })} />
                    }

                    { unit &&
                        <div className="qubely-unit-btn-group qubely-ml-auto">
                            { (typeof unit == 'object' ? unit : ['px', 'em', '%']).map((value) => (
                                <button className={( value == activePadding.unit ) ? 'active' : ''} onClick={ () => this.changeUnit(value) }>{value}</button>
                            )) }
                        </div>
                    }
                </div>
                    ...
                    <div className="qubely-drag-dimension-wrap">
                        ...
                        <div className="qubely-dimension-margin-wrap">
                            <div
                                ...
                                <div className="dimension-item margin-left" onMouseDown={ this.onMouseDownAction.bind(this, 'left')}>
                                    <span />{this.changeInput('margin',activeMargin.left,'left')}
                                </div>
                                <div className="dimension-item margin-top" onMouseDown={ this.onMouseDownAction.bind(this, 'top')} >
                                    <span />{this.changeInput('margin',activeMargin.top,'top')}
                                </div>
                                <div className="dimension-item margin-bottom" onMouseDown={ this.onMouseDownAction.bind(this, 'bottom')}>
                                    <span />{this.changeInput('margin',activeMargin.bottom,'bottom')}
                                </div>
                                <div className="dimension-item margin-right" onMouseDown={ this.onMouseDownAction.bind(this, 'right')}>
                                    <span />{this.changeInput('margin',activeMargin.right,'right')}
                                </div>
                            </div>
                            <div
                            ...
                            >
                                <div className="dimension-item padding-left" onMouseDown={ this.onMouseDownAction.bind(this, 'left')}>
                                    <span />{this.changeInput('padding',activePadding.left,'left')}
                                </div>
                                <div className="dimension-item padding-top" onMouseDown={ this.onMouseDownAction.bind(this, 'top')}>
                                    <span />{this.changeInput('padding',activePadding.top,'top')}
                                </div>
                                <div className="dimension-item padding-bottom" onMouseDown={ this.onMouseDownAction.bind(this, 'bottom')}>
                                    <span />{this.changeInput('padding',activePadding.bottom,'bottom')}
                                </div>
                                <div className="dimension-item padding-right" onMouseDown={ this.onMouseDownAction.bind(this, 'right')}>
                                    <span />{this.changeInput('padding',activePadding.right,'right')}
                                </div>
                            </div>
                        </div>
                    </div>
