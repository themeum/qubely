                            ...
                            { !qubely_admin.pro_enable ?
                                ...
                                <Fragment>
                                    <Toggle
                                        ...
                                        onChange={() => this._saveAttributes('while_scroll_into_view','enable', !while_scroll_into_view.enable)} />
                                        ...
                                        <Fragment>
                                            ...
                                            {this.state.isTransformOrigin &&  
                                                <div className="qubley-flex-d qubley-interaction-transform-origin">
                                                    <div className="qubley-interaction-transform-origin-label"><label> {__('Transform Origin')} </label></div>
                                                    <ButtonGroup
                                                        label={__('X-Axis')}
                                                        options={['left','center', 'right']}
                                                        value={transform_origin.x_offset}
                                                        onChange={(value) => this._saveAttributes('while_scroll_into_view','transform_origin_x', value)} 
                                                    />
                                                    ...
                                                    <ButtonGroup
                                                        ...
                                                        onChange={(value) => this._saveAttributes('while_scroll_into_view','transform_origin_y', value)} 
                                                    />
                                            ...
                                            <Toggle
                                                ...
                                                onChange={() => this._saveAttributes('while_scroll_into_view','enable_tablet', !while_scroll_into_view.enable_tablet)} />
                                            <Toggle
                                                label={__('Enable Mobile')}
                                                value={while_scroll_into_view.enable_mobile}
                                                onChange={() => this._saveAttributes('while_scroll_into_view','enable_mobile', !while_scroll_into_view.enable_mobile)} />
                                        </Fragment>
                                    }
                                </Fragment>
                            }
                    ...
                    <div className="sp-pagebuilder-list-view">
                        <div className="sppb-interaction-view-body">
                            <Toggle
                                ...
                                onChange={() => this._saveAttributes('mouse_movement','enable', !mouse_movement.enable)} />
                            { mouse_movement.enable &&                              
                                <Fragment>
                                    <ButtonGroup
                                        label={__('Direction')}
                                        options={['direct', 'opposite']}
                                        value={mouse_movement.mouse_tilt_direction}
                                        onChange={(value) => this._saveAttributes('mouse_movement','mouse_tilt_direction', value)} />
                                    
                                    <Range 
                                        label={__("Speed")} 
                                        value={parseFloat(mouse_movement.mouse_tilt_speed)} 
                                        onChange={(value) => this._saveAttributes('mouse_movement','mouse_tilt_speed', value)} 
                                        min={1} 
                                        max={10} 
                                        step={0.5}
                                    />
                                    <Range 
                                        ...
                                        onChange={(value) => this._saveAttributes('mouse_movement','mouse_tilt_max', value)} 
                                        min={5}
                                        max={75} 
                                        step={5}
                                    />
                                    ...
                                    <Toggle
                                        ...
                                        onChange={() => this._saveAttributes('mouse_movement','enable_tablet', !mouse_movement.enable_tablet)} />

                                    <Toggle
                                        label={__('Enable Mobile')}
                                        value={mouse_movement.enable_mobile}
                                        onChange={() => this._saveAttributes('mouse_movement','enable_mobile', !mouse_movement.enable_mobile)} />

                                    <button onClick={()=> this.enableTiltAnimation() } className="components-button is-button is-default is-primary is-large"> { this.state.liveMouseTilt ? "Stop" : "Live" } </button>
